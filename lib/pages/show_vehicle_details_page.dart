...
class VehicleDetailsPage extends StatelessWidget {
  ...
  final String vehicleId; // Add this property
  VehicleDetailsPage({super.key, required this.vehicleId});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: buildAppBar(context, 'Vehicle details',
          showMenu: false, isVisible: true),
